...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["main"], {
  ...
  function srcAppHomeHomeComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var uuid_dist_v4__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(
    /*! uuid/dist/v4 */
    "./node_modules/uuid/dist/v4.js");
    /* harmony import */


    var uuid_dist_v4__WEBPACK_IMPORTED_MODULE_2___default = /*#__PURE__*/__webpack_require__.n(uuid_dist_v4__WEBPACK_IMPORTED_MODULE_2__);
    /* harmony import */
    ...
    var HomeComponent = /*#__PURE__*/function () {
      ...
      _createClass(HomeComponent, [{
        ...
        value: function createRoom() {
          ...
          this.router.navigate(["/".concat(uuid_dist_v4__WEBPACK_IMPORTED_MODULE_2___default()())]);
        }
      }]);
  ...
  function srcAppRoomRoomComponentScss(module, __webpack_exports__, __webpack_require__) {
    ...
    __webpack_exports__["default"] = ".video-grid {\n  display: grid;\n  grid-template-columns: repeat(auto-fill, 300px);\n  grid-auto-rows: 300px;\n}\n\nvideo {\n  width: 90%;\n  height: 90%;\n  -o-object-fit: cover;\n     object-fit: cover;\n}\n/*# sourceMappingURL=data:application/json;base64, */";
    /***/
  },
  ...
  function srcAppRoomRoomComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var RoomComponent = /*#__PURE__*/function () {
      function RoomComponent(route, socket) {
      ...
      _createClass(RoomComponent, [{
        ...
        value: function ngOnInit() {
          ...
          var myPeer = new Peer(this.currentUserId, {
            ...
            // host: '/',
            // port: 3001,
            url: 'http://test-app-peer.herokuapp.com'
          });
          this.route.params.subscribe(function (params) {
            console.log(params);
            myPeer.on('open', function (userId) {
              _this.socket.emit('join-room', params.roomId, userId);
            });
          });
          navigator.mediaDevices.getUserMedia({
            ...
            if (stream) {
              _this.addMyVideo(stream);
            }

            myPeer.on('call', function (call) {
              console.log('receiving call...', call);
              call.answer(stream);
              call.on('stream', function (otherUserVideoStream) {
                console.log('receiving other stream', otherUserVideoStream);

                _this.addOtherUserVideo(call.metadata.userId, otherUserVideoStream);
              });
            ...
            _this.socket.on('user-connected', function (userId) {
              console.log('Receiving user-connected event', "Calling ".concat(userId)); // Let some time for new peers to be able to answer
              ...
              setTimeout(function () {
                ...
                call.on('stream', function (otherUserVideoStream) {
                  ...
                  _this.addOtherUserVideo(userId, otherUserVideoStream);
                });
                call.on('close', function () {
                  _this.videos = _this.videos.filter(function (video) {
          ...
          this.socket.on('user-disconnected', function (userId) {
            console.log("receiving user-disconnected event from ".concat(userId));
            _this.videos = _this.videos.filter(function (video) {
              return video.userId !== userId;
            });
          });
        ...
        key: "addMyVideo",
        value: function addMyVideo(stream) {
          this.videos.push({
            muted: true,
            srcObject: stream,
        ...
        key: "addOtherUserVideo",
        value: function addOtherUserVideo(userId, stream) {
          var alreadyExisting = this.videos.some(function (video) {
            return video.userId === userId;
          });
  ...
  function _(module, exports, __webpack_require__) {
    ...
    /*! /home/adiaz/development/angular-video-chat-app/front/src/main.ts */
    "./src/main.ts");
    /***/
  },
